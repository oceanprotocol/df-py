...
from df_py.web3util.dispense import dispense, multisig_transfer_tokens
...
def test_multisig_transfer_tokens(w3):
    OCEAN = OCEAN_token(DEV_CHAINID)
    with patch("df_py.web3util.dispense.chain_id_to_multisig_addr"):
        with patch("df_py.web3util.dispense.send_multisig_tx") as mock:
            multisig_transfer_tokens(w3, OCEAN, OCEAN.address, 1)
