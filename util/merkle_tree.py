#from https://github.com/raiden-network/raiden/blob/e43ebbb8c09407d9793e50b1005bfdb67c267b4a/raiden/transfer/merkle_tree.py

from hashlib import sha256

from util.exceptions import HashLengthNot32
from util.datastructures import split_in_pairs
...
def hash_pair(first, second):
    ...
    if first > second:
        return sha256(second + first).digest()
...
def merkle_leaves_from_packed_data(packed_data):
    ...
    for i in range(0, number_of_bytes, 96):
        leaves.append(sha256(packed_data[i: i + 96]))
    return leaves
