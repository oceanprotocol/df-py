...
WRAPPED_TOKEN_SYMBOLS = {
    _CHAINID_TO_NETWORK[8996]: "OCEAN",
    _CHAINID_TO_NETWORK[1]: "ETH",
    _CHAINID_TO_NETWORK[3]: "ETH",
    _CHAINID_TO_NETWORK[4]: "ETH",
    _CHAINID_TO_NETWORK[137]: "MATIC",
    _CHAINID_TO_NETWORK[56]: "BNB",
    _CHAINID_TO_NETWORK[246]: "EWT",
    _CHAINID_TO_NETWORK[1285]: "MOON",
    _CHAINID_TO_NETWORK[1287]: "MOON",
    _CHAINID_TO_NETWORK[80001]: "MATIC",
}
